...
public class OrcForgeAlloy implements Recipe<Inventory> {
    ...
    public OrcForgeAlloy(ItemStack output, Identifier id, boolean swappable, float xp, int cookTime, DefaultedList<Ingredient> possibleIngredients, DefaultedList<Ingredient> alloy) {
        this.output = output;
        this.id = id;
    ...
    public RecipeSerializer<?> getSerializer() {
        return LotrCrafting.ORC_ALLOY_FORGE;
    }

    @Override
    public RecipeType<?> getType() {
        return LotrCrafting.ORC_ALLOY;
    }
    ...
    public static class Serializer implements RecipeSerializer<OrcForgeAlloy> {

        @Override
        public OrcForgeAlloy read(Identifier id, JsonObject json) {
            ...
            return new OrcForgeAlloy(output , id, swappable, xp, cookTime, possibleInputs, possibleAlloys);
        }

        @Override
        public OrcForgeAlloy read(Identifier id, PacketByteBuf buf) {
            ...
            return new OrcForgeAlloy(output, id, swappable, xp, cookTime, possibleIngredients, possibleAlloys);
        }

        @Override
        public void write(PacketByteBuf buf, OrcForgeAlloy recipe) {
