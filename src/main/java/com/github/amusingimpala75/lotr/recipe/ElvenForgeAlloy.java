...
/*
Recipe for ElvenForge NOT alloy
 */
public class ElvenForgeAlloy implements Recipe<Inventory> {
    ...
    public ElvenForgeAlloy(ItemStack output, Identifier id, boolean swappable, float xp, int cookTime, DefaultedList<Ingredient> possibleIngredients, DefaultedList<Ingredient> alloy) {
        this.output = output;
        this.id = id;
    ...
    public RecipeSerializer<?> getSerializer() {
        return LotrCrafting.ELVEN_ALLOY_FORGE;
    }

    @Override
    public RecipeType<?> getType() {
        return LotrCrafting.ELVEN_ALLOY;
    }
    ...
    public static class Serializer implements RecipeSerializer<ElvenForgeAlloy> {

        @Override
        public ElvenForgeAlloy read(Identifier id, JsonObject json) {
            ...
            return new ElvenForgeAlloy(output , id, swappable, xp, cookTime, possibleInputs, possibleAlloys);
        }

        @Override
        public ElvenForgeAlloy read(Identifier id, PacketByteBuf buf) {
            ...
            return new ElvenForgeAlloy(output, id, swappable, xp, cookTime, possibleIngredients, possibleAlloys);
        }

        @Override
        public void write(PacketByteBuf buf, ElvenForgeAlloy recipe) {
