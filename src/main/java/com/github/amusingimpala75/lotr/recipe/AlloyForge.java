...
/*
Recipe for alloying in alloy forge
 */
public class AlloyForge implements Recipe<Inventory> {
    ...
    public AlloyForge(ItemStack output, Identifier id, boolean swappable, float xp, int cookTime, DefaultedList<Ingredient> possibleIngredients, DefaultedList<Ingredient> alloy) {
        this.output = output;
        this.id = id;
    ...
    public RecipeSerializer<?> getSerializer() {
        return LotrCrafting.ALLOY_FORGE;
    }

    @Override
    public RecipeType<?> getType() {
        return LotrCrafting.ALLOY_FORGE_TYPE;
    }
    ...
    public static class Serializer implements RecipeSerializer<AlloyForge> {

        @Override
        public AlloyForge read(Identifier id, JsonObject json) {
            ...
            return new AlloyForge(output , id, swappable, xp, cookTime, possibleInputs, possibleAlloys);
        }

        @Override
        public AlloyForge read(Identifier id, PacketByteBuf buf) {
            ...
            return new AlloyForge(output, id, swappable, xp, cookTime, possibleIngredients, possibleAlloys);
        }

        @Override
        public void write(PacketByteBuf buf, AlloyForge recipe) {
