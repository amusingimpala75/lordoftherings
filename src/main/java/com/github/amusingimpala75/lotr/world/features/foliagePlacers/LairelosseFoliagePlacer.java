...
public class LairelosseFoliagePlacer extends FoliagePlacer {
    public static Codec<LairelosseFoliagePlacer> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, instance.stable(LairelosseFoliagePlacer::new)));
    public LairelosseFoliagePlacer(UniformIntDistribution radius, UniformIntDistribution offset) {
        super(radius, offset);
    }
    //public LairelosseFoliagePlacer(int r, int rRand) {
    //    super(r, rRand, LOTRFoliagePlacers.LAIRELOSSE_FOLIAGE);
    //}

    //public <T> LairelosseFoliagePlacer(Dynamic<T> dyn) {
    ...
    protected FoliagePlacerType<?> getType() {
        return ModDefaultBiomeFeatures.LAIRELOSSE_FOLIAGE;
    }
